...
insert into SELLS (bid, mid, price) values (4, 5, '$4.00');
...
insert into SELLS (bid, mid, price) values (9, 5, '$4.00');
...
insert into RESERVATIONS (customer_id, branch_id, pax, reservedSlot, reservedDate, promo_used, confirmed) values (1, 6, 2, '10:00:00', current_date, null, true);
