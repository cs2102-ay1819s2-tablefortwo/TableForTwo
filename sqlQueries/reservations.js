let sqlQueries = {
    ...
    getCustomerReservations: 'SELECT B.bName, R.pax, R.reservedslot, R.reserveddate, P.promo_code FROM (Reservations R INNER JOIN Branches B ON R.branch_id = B.id) LEFT JOIN Promotions P on R.promo_used = P.promo_code WHERE R.customer_id = $1',
